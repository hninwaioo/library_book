...
class BookVOAdapter extends TypeAdapter<BookVO> {
  ...
  void write(BinaryWriter writer, BookVO obj) {
    writer
      ...
      ..write(obj.listName)
      ..writeByte(27)
      ..write(obj.isAddedLibrary)
      ..writeByte(28)
      ..write(obj.isAddedShelf);
  }
...
BookVO _$BookVOFromJson(Map<String, dynamic> json) => BookVO(
      ...
      json['is_added_library'] as bool?,
      json['is_added_shelf'] as bool?,
    );
...
Map<String, dynamic> _$BookVOToJson(BookVO instance) => <String, dynamic>{
      ...
      'is_added_library': instance.isAddedLibrary,
      'is_added_shelf': instance.isAddedShelf,
    };
