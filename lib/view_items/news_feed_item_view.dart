...
class NewsFeedItemView extends StatelessWidget {
  ...
  // NewsFeedItemView({required this.newsFeedVO});
      ...
      children: [
        Container(
          ...
          child: Row(
            children: [
              ProfileImageView(
                  profileImage: "https://w0.peakpx.com/wallpaper/224/824/HD-wallpaper-beauty-red-model-rose-girl-hand-flower-face-woman.jpg"
              ...
              Spacer(),
              Icon(Icons.more_vert_sharp, color: PRIMARY_HINT_COLOR,)
            ],
          ),
        ),
...
class SeeCommentAndLikeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          TypicalText("See Comments", PRIMARY_HINT_COLOR, TEXT_REGULAR),
